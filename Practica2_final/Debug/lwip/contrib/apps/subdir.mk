...
C_SRCS += \
../lwip/contrib/apps/tcpecho.c \
../lwip/contrib/apps/udpecho.c 

OBJS += \
./lwip/contrib/apps/tcpecho.o \
./lwip/contrib/apps/udpecho.o 

C_DEPS += \
./lwip/contrib/apps/tcpecho.d \
./lwip/contrib/apps/udpecho.d 


# Each subdirectory must supply rules for building sources it contributes
lwip/contrib/apps/%.o: ../lwip/contrib/apps/%.c
	@echo 'Building file: $<'
